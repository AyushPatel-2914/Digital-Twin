...
# ============================================================
# 🧠 STEP 3: AUTO-DETECT PIT CENTERS
# ============================================================
...
ax.set_title("3D Coal Mine Map (Road Network Only)")
ax.set_xlabel("X")
ax.set_ylabel("Y")
...
# Save this at end of your 3D map file
...
# Save file
with open("nodes_3d_map.json", "w") as f:
    json.dump(json_data, f, indent=4)

print("✅ JSON file 'nodes_3d_map.json' created successfully!")
...
# ============================================================
# 🔗 FILTER EDGES (ONLY VALID NODE CONNECTIONS)
# ============================================================
...
with open("map_filtered.json", "w") as f:
    json.dump(final_data, f, indent=4)

print("✅ JSON with nodes + edges created!")

import json

# ============================================================
# 💾 EXPORT ALL NODES + EDGES
# ============================================================
...
# Save JSON file
with open("full_map_3d.json", "w") as f:
    json.dump(final_data, f, indent=4)

print("✅ Full map JSON created: full_map_3d.json")